...
![Architecture](https://img.shields.io/badge/Arch-Producer_Consumer-orange)
...
O grande diferencial deste projeto não é apenas detectar a qualidade de exercícios com **YOLOv11**, mas garantir a **Observabilidade Total** do pipeline de inferência. Diferente de implementações acadêmicas, esta arquitetura foi desenhada para produção, monitorando latência, vazão (throughput) e saúde do modelo em tempo real.
